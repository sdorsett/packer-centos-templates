node ('packer.clifflabs.local') {
  ...
  parallel (
    phase1: { 
      ...
      stage ('Deploy CentOS 6.8 Puppet 4.3.2 template') {
        echo "Deploy CentOS 6.8 Puppet 4.3.2 template" 
    ...
    phase2: {
      ...
      stage ('Deploy CentOS 6.8 Puppet Enterprise 3.8.2 template') {
        echo "Deploy CentOS 6.8 Puppet Enterprise 3.8.2 template"
